                ...
                {!resultado.encontrada ? (
                  ...
                  <div>
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div><p className="font-bold text-green-800 text-lg">¡Lista para recoger!</p></div>
                    </div>
                    
                    {resultado.desglose ? (
                      <div className="bg-white rounded-xl p-4 mt-4 border-2 border-green-200">
                        <p className="font-semibold text-gray-700 mb-3">Desglose:</p>
                        <div className="space-y-2">
                          {resultado.desglose.split('\n').map((linea, i) => {
                        ...
                        <div className="mt-3 pt-3 border-t-2 border-green-200 flex justify-between items-center">
                          ...
                          <span className="text-2xl font-bold text-green-600">{resultado.precio}€</span>
                        </div>
                      </div>
                    ) : (
                      <div className="mt-4">
                        <p className="text-green-700">Total: <strong className="text-2xl">{resultado.precio}€</strong></p>
                      </div>
                    )}
                  </div>
                )}
